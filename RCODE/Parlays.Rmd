...
threepick <- slice_min(profit2, profit2$Odds, n = 3, with_ties = FALSE)

fourpick <- slice_min(profit2, profit2$Odds, n = 4, with_ties = FALSE)

fivepick <- slice_min(profit2, profit2$Odds, n = 5, with_ties = FALSE)

sixpick <- slice_min(profit2, profit2$Odds, n = 6, with_ties = FALSE)
