...
twopick <- slice_min(profit2, profit$Odds, n = 2)

threepick <- slice_min(profit2, profit$Odds, n = 3)

fourpick <- slice_min(profit2, profit$Odds, n = 4)

fivepick <- slice_min(profit2, profit$Odds, n = 5)

sixpick <- slice_min(profit2, profit$Odds, n = 6)
